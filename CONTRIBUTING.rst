...
When `reporting a bug <https://github.com/woile/flashcards/issues>`_ please include:
...
1. Fork `flashcards <https://github.com/woile/flashcards>`_
...
.. [1] If you don't have all the necessary python versions available locally you can rely on Travis - it will
       `run the tests <https://travis-ci.org/woile/flashcards/pull_requests>`_ for each change you add in the pull request.
